@php
if (Auth::check()) {
  $datakeranjang = \App\Model\Keranjang::with('produk')->where('user_id',Auth::user()->id)->get();;
}
@endphp
        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
            ...
            <li class="nav-item dropdown dropdown-cart mr-25"><a class="nav-link" href="javascript:void(0);"
                ...
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                    ...
                    @if (Auth::check())
                    @foreach ($datakeranjang as $key => $item)
                    <li class="scrollable-container media-list">
                        <div class="media align-items-center">
                            <img class="d-block rounded mr-1" src="{{asset('zsh/app-assets/images/pages/eCommerce/1.png')}}" alt="donuts" width="62">
                            <div class="media-body">
                                <div class="media-heading">
                                    <h6 class="cart-item-title"><a class="text-body" href="app-ecommerce-details.html">
                                        </a>{{$item->produk->nama_produk}}</h6><small class="cart-item-by">By
                                        Apple</small>
                                </div>
                                <div class="cart-item-qty">
                                        <p>Qty : <strong>{{$item->jumlah}}</strong></p>
                                </div>
                                <h5 class="cart-item-price">Rp. {{number_format($item->produk->harga)}}</h5>
                            </div>
                        </div>
                    </li>
                    @php
                    $totalkeranjang += $item->harga * $item->jumlah;
                    @endphp
                    @endforeach
                    @endif
                    ...
                    <li class="dropdown-menu-footer">
                        <div class="d-flex justify-content-between mb-1">
                            ...
                            <h6 class="text-primary font-weight-bolder mb-0">Rp {{number_format($totalkeranjang)}}
                            </h6>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <a class="btn btn-primary btn-block" href="{{route('keranjang.detail')}}">Keranjang</a>
                            </div>
                            <div class="col-6">
                                <a class="btn btn-primary btn-block" href="{{route('checkout.index')}}">Checkout</a>
                            </div>
                        </div>
                    </li>
                </ul>
                ...
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                    ...
                    <li class="scrollable-container media-list"><a class="d-flex" href="javascript:void(0)">
                            <div class="media d-flex align-items-start">
                                <div class="media-left">
                                    <div class="avatar"><img
                                            src="{{asset('zsh/app-assets/images/portrait/small/avatar-s-15.jpg')}}"
                            ...
                            <div class="media d-flex align-items-start">
                                <div class="media-left">
                                    <div class="avatar"><img
                                            src="{{asset('zsh/app-assets/images/portrait/small/avatar-s-3.jpg')}}"
                                            alt="avatar" width="32" height="32"></div>
                                </div>
                                <div class="media-body">
                ...
                <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
                    ...
                    <div class="user-nav d-sm-flex d-none"><span
                        ...
                        class="avatar"><img class="round"
                            src="{{asset('zsh/app-assets/images/portrait/small/avatar-s-11.jpg')}}" alt="avatar"
                            height="40" width="40"><span class="avatar-status-online"></span></span>
                    </a>
                @else
                <a class="nav-link dropdown-toggle dropdown-user-link" href="#" aria-haspopup="true"
                    aria-expanded="false">
                    <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder"></div><span
                        class="avatar"><img class="round"
...
<ul class="main-search-list-defaultlist d-none">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
            ...
            <div class="d-flex">
                <div class="mr-75"><img src="{{asset('zsh/app-assets/images/icons/xls.png')}}" alt="png" height="32">
                </div>
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
            href="app-file-manager.html">
            <div class="d-flex">
                <div class="mr-75"><img src="{{asset('zsh/app-assets/images/icons/jpg.png')}}" alt="png" height="32">
                </div>
                <div class="search-data">
