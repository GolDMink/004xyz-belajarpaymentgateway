...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('zsh/app-assets/css/plugins/forms/form-validation.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('zsh/app-assets/css/pages/page-auth.css')}}">
    <!-- END: Page CSS-->
...
<body class="horizontal-layout horizontal-menu blank-page navbar-floating footer-static  " data-open="hover" data-menu="horizontal-menu" data-col="blank-page">
    ...
    <script src="{{asset('zsh/app-assets/vendors/js/forms/validation/jquery.validate.min.js')}}"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{asset('zsh/app-assets/js/scripts/pages/page-auth-login.js')}}"></script>
    <!-- END: Page JS-->
